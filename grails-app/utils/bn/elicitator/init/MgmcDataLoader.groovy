...
class MgmcDataLoader extends DataLoader {
	...
	protected List<Variable> getBackgroundVariables() {
		...
		List<Variable> backgroundVars = [
			...
			new Variable(
				label: "Capacity",
				description: "The maximum number of attendees allowed to be present at an event.",
				readableLabel: "Venue capacity" ),
			...
			new Variable(
				label: "EventDuration",
				usageDescription: "Do any of the following variables influence the Duration of an event?",
			...
			new Variable(
				label: "Seated",
				usageDescription: "Do any of the following variables influence whether the attendees sit or stand at an event?",
				readableLabel: "Seated or standing" ),

			new Variable(
				label: "EventVenue",
				usageDescription: "Do any of the following variables influence the Venue an event is held at?",
				readableLabel: "Venue" ),

			new Variable(
				label: "GatheringType",
				description: "Examples of event types include concerts, sporting events, or local festivals.",
				usageDescription: "Do any of the following variables influence the Event type?",
			...
			new Variable(
				...
				usageDescription: "Do any of the following variables influence whether an event is [This]?",
		...
		String usageBackground = "Do any of the following variables influence the [This] at an event?";
		backgroundVars.each {
	...
	protected List<Variable> getProblemVariables() {
		...
		List<Variable> problemVars = [
			...
			new Variable(
				...
				description: "The patients who do not present with any problems, but may ask for some paracetamol, a bandaid or perhaps some sunscreen.",
				usageDescription: "Do any of the following variables influence the chance of a patient requesting Medication/supplies at an event?",
				readableLabel: "Medication/supplies request",
		...
		String usageProblem    = "Do any of the following variables influence the chance of patients suffering from [This] at an event?";
		problemVars.each {
			if ( !it.usageDescription ) {
